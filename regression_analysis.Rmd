...
---
We are interested in the factors that potentially effect the revenue of each taxi trip. The total amount is calculated by fare amount, tax, tip amount, tolls amount and [improvement surcharge](https://www1.nyc.gov/site/tlc/about/taxi-improvement-fund.page). Since tax 


## Fare Amount
The initial charge of NYC Yellow Cab is 2.5 dollars. However, the rule of standard metered [taxi fare](https://www1.nyc.gov/site/tlc/passengers/taxi-fare.page) is too complicated. It is difficult for a passenger to estimate the fare amount refering to such complext instructions.
