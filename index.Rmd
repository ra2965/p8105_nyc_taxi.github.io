...
* We found no significant association between weather and Taxi drives. However, Feburary did have more daily taxi usage compared to other month, we concluded that extreme bad weather in Feburary did sitimulate taxi service in New York City.

* Heatmap:

* We also fitted a linear regression model to further analyze the asssociation between fare amount/tip percent and travel time and distance.   

## Data sources:
>>>>>>> b4f4253fc7f5b2c046427a60b391fbff766bd3b4
...
For 2018, although we hypothesis that adverse weather event like low and high average daily temperature and precipitation will increase taxi usage, we did find an obvious trend. This can be due to the limitation of sample size, as we only generate 12000 observation from the larger database. Also, facotrs like travel distance and time might affect taxi use, as people might only choose taxi drive for shorter distance. 
