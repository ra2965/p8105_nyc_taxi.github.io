...
Here we make an animation plot to show the daily drive amount and average daily temperature for each month. Although we hypothesis that cold weather and hot weather might have more taxi use, there is no obvious difference for different daily temperature. There is a slightly increase daily taxi usage in Feburary.
