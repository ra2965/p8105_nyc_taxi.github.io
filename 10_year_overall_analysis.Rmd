...
```{r overall_df, message=FALSE, warning=FALSE}
...
#### NYC yellow cab ride and passenger numbers are decreasing
...
#### NYC yellow cab is more expensive for a single ride 
...
#### NYC yellow cab gets lower income 
